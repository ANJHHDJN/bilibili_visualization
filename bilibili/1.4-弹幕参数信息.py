...
class BiliSpider:
    def __init__(self,BV):
        ...
        self.headers = {"User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.77 Safari/537.36 Edg/91.0.864.41"}
    ...
    # Xpath不能解析指明编码格式的字符串，所以此处不解码，还是二进制文本
